            ...
            <div className="drawer-side">
                ...
                <ul className={`menu w-80 bg-base-100 text-base-content border-l relative border-gray-200  ${isOpen ? '' : 'hidden'}`}>
                    ...
                    <div className="self-center text-center">
                        ...
                        <div className="mt-2 font-bold relative">{chatRoomName}<label htmlFor="chatname" className = "cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="absolute right-0 bottom-0 w-5 h-5">
