  ...
  return (
    <>
      ...
      <ConfirmationDialog
        ...
        title={chatroomType === "private" ? "Unfriend User" : "Leave Team"}
        description={`Are you sure you want to ${
          chatroomType === "private" ? "unfriend this user" : "leave this team"
        }?`}
        onConfirm={() => {
          chatroomType === "private" ? handleUnfriendUser() : handleLeaveTeam();
        }}
      />
    </>
  );
